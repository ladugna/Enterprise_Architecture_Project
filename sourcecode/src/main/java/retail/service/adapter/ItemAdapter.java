...
public class ItemAdapter {
    ...
    private static Item getSingleItemFromItemRequest(ItemRequest itemRequest) {
        return new SingleItem(itemRequest.getId(),itemRequest.getName(), itemRequest.getDescription(), itemRequest.getImage(),
                itemRequest.getBarcodeNumber(), itemRequest.getPrice(), itemRequest.getQuantityInStock(), itemRequest.getCategory());
    }

    private static Item getCompositeItemFromItemRequest(ItemRequest itemRequest) {
        Item item = new CompositeItem(itemRequest.getId(), itemRequest.getName(), itemRequest.getDescription(),
                itemRequest.getImage(), itemRequest.getBarcodeNumber(), itemRequest.getPrice(), itemRequest.getQuantityInStock(), itemRequest.getCategory());
